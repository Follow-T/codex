...
/**
 * @InterfaceName AuditReceivablesMapper
 * @Description 应收数据接口定义
 * @Author zhaolijun
 * @Date 2019/7/15 10:13
 * @Version 1.0
 **/
@Component
public interface AuditReceivablesMapper {
     ...
     * @param map
     */
    void insertAuRcbBossOut(Map<String,Object> map);

    /**
     * 批量保存应收项目明细
     * @param projectList
     */
    void insertAuRcbBossOutLineBatch(List<Map<String,Object>> projectList);
     ...
     * @return
     */
    int selectDtRegisterCount(Map<String,Object> map);
     ...
     * @param id 主表id
     */
    void deleteYsDetailLineHand(@Param("id") String id);
