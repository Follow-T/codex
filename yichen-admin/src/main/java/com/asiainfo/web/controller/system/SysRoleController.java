...
public class SysRoleController extends BaseController
{
    ...
    public String test()
    {
        return "config/channelSigning/channelSigning";
    }
    
    @GetMapping("/test/edit")
    public String Edit()
    {
        return "config/channelSigning/edit";
    }
    
    @GetMapping("/channelOutlets")
    public String channelOutlets()
    {
        return "config/channelSigning/channelOutlets/channelOutlets";
    }
    
    @GetMapping("/channelOutlets/edit")
    public String channelOutletsEdit()
    {
        return "config/channelSigning/channelOutlets/edit";
    }
